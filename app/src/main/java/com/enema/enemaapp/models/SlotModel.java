...
public class SlotModel  {
    ...
    String slot_date, slot_day, slot_month, slot_year, slot_id;

    public  SlotModel(){}

    public SlotModel(String slot_date, String slot_day, String slot_month, String slot_year, String slot_id) {
